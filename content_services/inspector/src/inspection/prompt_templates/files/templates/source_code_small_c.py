...
SOURCE_CODE_SMALL_TEMPLATE_C = [
    ...
    (S.FN_COND_JSON,       "\n---\n## Global Variables", c_variables_checker, variables_dict_from_llm_c, None),
    (S.FN_COND_JSON,       "\n---\n## Data Structures", c_data_structure_checker, data_structure_dict_from_llm_c, None,),
    (S.FN_COND_JSON,       "\n---\n## Functions", c_function_checker, fn_dict_from_llm_c, None,),
]
