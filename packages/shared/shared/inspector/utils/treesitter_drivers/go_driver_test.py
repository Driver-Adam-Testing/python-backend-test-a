...
@pytest.mark.parametrize(
    "expected_call_name, expected_line_range, expected_complete_call_site_name, expected_goroutine, expected_built_in",
    [
        ("len", (40, 40), "len", False, True),
        ("make", (41, 41), "make", False, True),
        ("Printf", (42, 42), "fmt.Printf", False, False),
        ("Abs", (45, 45), "math.Abs", False, False),
        ("ToUpper", (46, 46), "strings.ToUpper", False, False),
        ("Printf", (47, 47), "fmt.Printf", False, False),
        ("Add", (54, 54), "calc.Add", False, False),
        ("Printf", (55, 55), "fmt.Printf", False, False),
        ("GetValue", (55, 55), "calc.GetValue", False, False),
        ("Increment", (59, 59), "counter.Increment", False, False),
        ("Increment", (60, 60), "counter.Increment", False, False),
        ("Printf", (61, 61), "fmt.Printf", False, False),
        ("Value", (61, 61), "counter.Value", False, False),
        ("Printf", (67, 67), "fmt.Printf", False, False),
        ("Join", (68, 68), "strings.Join", False, False),
        ("Printf", (69, 69), "fmt.Printf", False, False),
        ("divide", (72, 72), "divide", False, False),
        ("Printf", (73, 73), "fmt.Printf", False, False),
        ("sum", (82, 82), "sum", False, False),
        ("sum", (83, 83), "sum", False, False),
        ("sum", (85, 85), "sum", False, False),
        ("Printf", (86, 86), "fmt.Printf", False, False),
        ("Printf", (103, 103), "fmt.Printf", False, False),
        ("Printf", (110, 110), "fmt.Printf", False, False),
        ("scale", (110, 110), "scale", False, False),
        ("Max", (115, 115), "Max", False, False),
        ("Max", (116, 116), "Max", False, False),
        ("Printf", (117, 117), "fmt.Printf", False, False),
        ("Max", (120, 120), "Max[float64]", False, False),
        ("Printf", (121, 121), "fmt.Printf", False, False),
        ("Sprintf", (125, 125), "fmt.Sprintf", False, False),
        ("Sprintf", (125, 125), "fmt.Sprintf", False, False),
        ("close", (134, 134), "close", False, True),
        ("make", (139, 139), "make", False, True),
        ("sendValues", (142, 142), "sendValues", True, False),
        ("Printf", (146, 146), "fmt.Printf", False, False),
        ("make", (150, 150), "make", False, True),
        ("Sleep", (152, 152), "time.Sleep", False, False),
        ("Printf", (158, 158), "fmt.Printf", False, False),
        ("After", (159, 159), "time.After", False, False),
        ("Println", (160, 160), "fmt.Println", False, False),
        ("Sprintf", (167, 167), "fmt.Sprintf", False, False),
        ("len", (167, 167), "len", False, True),
        ("ToUpper", (167, 167), "strings.ToUpper", False, False),
        ("Println", (168, 168), "fmt.Println", False, False),
        ("Format", (171, 171), "time.Now().Add(1 * time.Hour).Format", False, False),
        ("Add", (171, 171), "time.Now().Add", False, False),
        ("Now", (171, 171), "time.Now", False, False),
        ("Printf", (172, 172), "fmt.Printf", False, False),
        ("basicCalls", (176, 176), "basicCalls", False, False),
        ("methodCalls", (178, 178), "methodCalls", False, False),
        ("multipleArgsReturns", (180, 180), "multipleArgsReturns", False, False),
        ("variadicCalls", (182, 182), "variadicCalls", False, False),
        ("anonymousCalls", (184, 184), "anonymousCalls", False, False),
        ("genericCalls", (186, 186), "genericCalls", False, False),
        ("goroutineCalls", (188, 188), "goroutineCalls", False, False),
        ("errorCalls", (190, 190), "errorCalls", False, False),
        ("nestedCalls", (192, 192), "nestedCalls", False, False),
    ],
)
def test_extract_calls(
    ...
    assert (
        ...
        f"Expected call ({expected_call_name}, {expected_line_range}, {expected_complete_call_site_name}, {expected_goroutine}, {expected_built_in}) "
