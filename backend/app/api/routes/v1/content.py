...
from app.schemas.content_schema import (
    ...
    TagAssociationRequest, ContentCollectionAssociationRequest, DeleteContentSourcesRequest,
...
def batch_disassociate_sources(
    ...
    for source_id in source_content_associations.source_ids:
        try:
            ...
            results.append(DeleteDocumentSourceResponse(document_id=content_id, source_id=source_id,
