...
class TestTypeScriptDriver:
    ...
    # Test imports
    def test_extract_imports_count(self, imports_code: str):
    ...
    # Test functions
    def test_extract_functions_count(self, functions_code: str):
    ...
    # Test classes
    def test_extract_classes_count(self, classes_code: str):
    ...
    @pytest.mark.parametrize(
        "class_name,expected_line",
        [
            ("SimpleClass", 4),
            ("ClassWithProperties", 11),
            ("ClassWithMethods", 27),
            ("ParameterProperties", 46),
            ("GettersSetters", 56),
            ("Animal", 81),
            ("Dog", 93),  # Extends Animal
            ("Shape", 110),  # Abstract class
            ("Circle", 120),
            ("Container", 135),  # Generic class
            ("Bird", 180),  # Implements interface
            ("AppComponent", 215),  # With decorators
            ("PrivateFields", 287),  # ES2022 private fields
        ],
    )
    def test_extract_specific_classes(
        self, classes_code: str, class_name: str, expected_line: int, is_abstract: bool
    ):
        tree = TypeScriptDriverTree(classes_code, "test_classes.ts")
        classes = tree.extract_data_structure_definitions()
    ...
    # Test interfaces
    def test_extract_interfaces_count(self, interfaces_code: str):
    ...
    # Test variables
    def test_extract_variables_count(self, variables_code: str):
    ...
    # Test enums
    def test_extract_enums_count(self, enums_code: str):
    ...
    # Test methods
    def test_extract_methods_count(self, methods_code: str):
    ...
    def test_extract_modules_count(self, modules_code: str):
    ...
    # Test function calls
    def test_extract_function_calls_count(self, functions_code: str):
        tree = TypeScriptDriverTree(functions_code, "test_functions.ts")
    ...
    # Test edge cases
    def test_decorators(self, classes_code: str):
    ...
    def test_generic_types(self, interfaces_code: str):
    ...
    def test_type_aliases(self, interfaces_code: str):
    ...
    def test_namespace_members(self, modules_code: str):
    ...
    def test_no_duplicates(self, functions_code: str):
    ...
    def test_nested_structures(self, classes_code: str):
    ...
    def test_method_overloading(self, methods_code: str):
    ...
    def test_symbols_not_extracted(self, variables_code: str):
    ...
    def test_export_extraction(self, imports_code: str):
        ...
        functions = tree.extract_callable_definitions()
        exported = [f for f in functions if "export" in f.symbol_code]
        # Should find exported functions

    def test_ambient_declarations(self, modules_code: str):
