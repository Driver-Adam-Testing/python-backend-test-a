...
from shared.inspector.inspection.prompt_templates.files.templates.metadata_medium_default import (
    METADATA_MEDIUM_TEMPLATE,
)
from shared.inspector.inspection.prompt_templates.files.templates.metadata_multi_context_default import (
    METADATA_MULTI_CONTEXT_TEMPLATE,
)
from shared.inspector.inspection.prompt_templates.files.templates.metadata_small_default import (
    METADATA_SMALL_TEMPLATE,
)
from shared.inspector.inspection.prompt_templates.files.templates.source_code_large_assembly import (
    SOURCE_CODE_LARGE_TEMPLATE_ASSEMBLY,
)
from shared.inspector.inspection.prompt_templates.files.templates.source_code_large_assembly_multi_prompt import (
    SOURCE_CODE_LARGE_MULTI_PROMPT_TEMPLATE_ASSEMBLY,
)
from shared.inspector.inspection.prompt_templates.files.templates.source_code_large_c import (
    SOURCE_CODE_LARGE_TEMPLATE_C,
)
from shared.inspector.inspection.prompt_templates.files.templates.source_code_large_c_multi_prompt import (
    SOURCE_CODE_LARGE_MULTI_PROMPT_TEMPLATE_C,
)
from shared.inspector.inspection.prompt_templates.files.templates.source_code_large_cpp import (
    SOURCE_CODE_LARGE_TEMPLATE_CPP,
)
from shared.inspector.inspection.prompt_templates.files.templates.source_code_large_cpp_multi_prompt import (
    SOURCE_CODE_LARGE_MULTI_PROMPT_TEMPLATE_CPP,
)
from shared.inspector.inspection.prompt_templates.files.templates.source_code_large_cs import (
    SOURCE_CODE_LARGE_TEMPLATE_CS,
)
from shared.inspector.inspection.prompt_templates.files.templates.source_code_large_cs_multi_prompt import (
    SOURCE_CODE_LARGE_MULTI_PROMPT_TEMPLATE_CS,
)
from shared.inspector.inspection.prompt_templates.files.templates.source_code_large_default import (
    SOURCE_CODE_LARGE_TEMPLATE_DEFAULT,
)
from shared.inspector.inspection.prompt_templates.files.templates.source_code_large_go import (
    SOURCE_CODE_LARGE_TEMPLATE_GO,
)
from shared.inspector.inspection.prompt_templates.files.templates.source_code_large_go_multi_prompt import (
    SOURCE_CODE_LARGE_MULTI_PROMPT_TEMPLATE_GO,
)
from shared.inspector.inspection.prompt_templates.files.templates.source_code_large_header import (
    SOURCE_CODE_LARGE_TEMPLATE_HEADER,
)
from shared.inspector.inspection.prompt_templates.files.templates.source_code_large_header_multi_prompt import (
    SOURCE_CODE_LARGE_MULTI_PROMPT_TEMPLATE_HEADER,
)
from shared.inspector.inspection.prompt_templates.files.templates.source_code_large_java import (
    SOURCE_CODE_LARGE_TEMPLATE_JAVA,
)
from shared.inspector.inspection.prompt_templates.files.templates.source_code_large_java_multi_prompt import (
    SOURCE_CODE_LARGE_MULTI_PROMPT_TEMPLATE_JAVA,
)
from shared.inspector.inspection.prompt_templates.files.templates.source_code_large_js_ts import (
    SOURCE_CODE_LARGE_TEMPLATE_JS_TS,
)
from shared.inspector.inspection.prompt_templates.files.templates.source_code_large_js_ts_multi_prompt import (
    SOURCE_CODE_LARGE_MULTI_PROMPT_TEMPLATE_JS_TS,
)
from shared.inspector.inspection.prompt_templates.files.templates.source_code_large_py import (
    SOURCE_CODE_LARGE_TEMPLATE_PY,
)
from shared.inspector.inspection.prompt_templates.files.templates.source_code_large_py_multi_prompt import (
    SOURCE_CODE_LARGE_MULTI_PROMPT_TEMPLATE_PY,
)
from shared.inspector.inspection.prompt_templates.files.templates.source_code_large_ruby import (
    SOURCE_CODE_LARGE_TEMPLATE_RUBY,
)
from shared.inspector.inspection.prompt_templates.files.templates.source_code_large_ruby_multi_prompt import (
    SOURCE_CODE_LARGE_MULTI_PROMPT_TEMPLATE_RUBY,
)
from shared.inspector.inspection.prompt_templates.files.templates.source_code_large_rust import (
    SOURCE_CODE_LARGE_TEMPLATE_RUST,
)
from shared.inspector.inspection.prompt_templates.files.templates.source_code_large_rust_multi_prompt import (
    SOURCE_CODE_LARGE_MULTI_PROMPT_TEMPLATE_RUST,
)
from shared.inspector.inspection.prompt_templates.files.templates.source_code_large_verilog import (
    SOURCE_CODE_LARGE_TEMPLATE_VERILOG,
)
from shared.inspector.inspection.prompt_templates.files.templates.source_code_large_verilog_multi_prompt import (
    SOURCE_CODE_LARGE_MULTI_PROMPT_TEMPLATE_VERILOG,
)
from shared.inspector.inspection.prompt_templates.files.templates.source_code_multi_context_default import (
    SOURCE_CODE_MULTI_CONTEXT_TEMPLATE_DEFAULT,
)
from shared.inspector.inspection.prompt_templates.files.templates.source_code_small_assembly import (
    SOURCE_CODE_SMALL_TEMPLATE_ASSEMBLY,
)
from shared.inspector.inspection.prompt_templates.files.templates.source_code_small_c import (
    SOURCE_CODE_SMALL_TEMPLATE_C,
)
from shared.inspector.inspection.prompt_templates.files.templates.source_code_small_cpp import (
    SOURCE_CODE_SMALL_TEMPLATE_CPP,
)
from shared.inspector.inspection.prompt_templates.files.templates.source_code_small_cs import (
    SOURCE_CODE_SMALL_TEMPLATE_CS,
)
from shared.inspector.inspection.prompt_templates.files.templates.source_code_small_default import (
    SOURCE_CODE_SMALL_TEMPLATE_DEFAULT,
)
from shared.inspector.inspection.prompt_templates.files.templates.source_code_small_go import (
    SOURCE_CODE_SMALL_TEMPLATE_GO,
)
from shared.inspector.inspection.prompt_templates.files.templates.source_code_small_header import (
    SOURCE_CODE_SMALL_TEMPLATE_HEADER,
)
from shared.inspector.inspection.prompt_templates.files.templates.source_code_small_java import (
    SOURCE_CODE_SMALL_TEMPLATE_JAVA,
)
from shared.inspector.inspection.prompt_templates.files.templates.source_code_small_js_ts import (
    SOURCE_CODE_SMALL_TEMPLATE_JS_TS,
)
from shared.inspector.inspection.prompt_templates.files.templates.source_code_small_py import (
    SOURCE_CODE_SMALL_TEMPLATE_PY,
)
from shared.inspector.inspection.prompt_templates.files.templates.source_code_small_ruby import (
    SOURCE_CODE_SMALL_TEMPLATE_RUBY,
)
from shared.inspector.inspection.prompt_templates.files.templates.source_code_small_rust import (
    SOURCE_CODE_SMALL_TEMPLATE_RUST,
)
from shared.inspector.inspection.prompt_templates.files.templates.source_code_small_verilog import (
