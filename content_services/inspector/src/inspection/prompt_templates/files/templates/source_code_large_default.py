...
SOURCE_CODE_LARGE_TEMPLATE_DEFAULT = [
    ...
    (S.SINGLE_PROMPT_TEXT, "## Technical Summary", SOURCE_CODE_SYSTEM_PROMPT_GENERAL_DEFAULT, TECHNICAL_SUMMARY_USER_PROMPT,),
    (S.SINGLE_PROMPT_TEXT, "## Imports and Dependencies", SOURCE_CODE_SYSTEM_PROMPT_GENERAL_DEFAULT, IMPORTS_USER_PROMPT,),
