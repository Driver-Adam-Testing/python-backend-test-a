...
class TestFQN:
    def test_fully_qualified_path_global_class(self) -> None:
    ...
    def test_fully_qualified_path_namespace(self) -> None:
    ...
    def test_fully_qualified_path_nested_namespaces(self) -> None:
    ...
    def test_fully_qualified_path_nested_classes(self) -> None:
    ...
    def test_fully_qualified_path_namespace_and_nested_class(self) -> None:
    ...
    def test_fully_qualified_path_mixed_structures(self) -> None:
    ...
    def test_fully_qualified_path_deeply_nested(self) -> None:
    ...
    def test_fully_qualified_path_anonymous_namespace(self) -> None:
    ...
    def test_fully_qualified_path_nested_anonymous_namespaces(self) -> None:
    ...
    def test_fully_qualified_path_mixed_named_and_anonymous(self) -> None:
    ...
    def test_fully_qualified_path_anonymous_with_nested_classes(self) -> None:
    ...
    def test_extract_function_calls_within_function_definition(self) -> None:
    ...
    """
        ...
        helper_call = next(
            call for call in calls_in_main if call.name == "helper_function"
        )
    ...
    def test_extract_function_calls_within_class_member_function(self) -> None:
    ...
    """
        ...
        assert (
            global_helper_call.fully_qualified_parent_path == "Calculator::processValue"
        )
