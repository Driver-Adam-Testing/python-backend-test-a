...
SOURCE_CODE_LARGE_TEMPLATE_CPP = [
    ...
    (S.FN_COND_JSON,       "\n---\n## Global Variables", cpp_variables_checker, variables_dict_from_llm_cpp, VARIABLES_NONE_CONTENT),
    (S.FN_COND_JSON,       "\n---\n## Data Structures", cpp_data_structure_checker, data_structure_dict_from_llm_cpp, DATA_STRUCTURES_NONE_CONTENT,),
    (S.FN_COND_JSON,       "\n---\n## Functions", cpp_function_checker, fn_dict_from_llm_cpp, FUNCTIONS_NONE_CONTENT,),
]
