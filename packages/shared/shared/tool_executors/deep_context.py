...
def get_architecture_overview(org_id: str, codebase_name: str) -> str:
...
def get_llm_onboarding_guide(org_id: str, codebase_name: str) -> str:
    dc = _get_root_node_content(
...
def get_changelog(org_id: str, codebase_name: str) -> str:
    dc = _get_root_node_content(
...
def get_detailed_changelog(
    org_id: str, codebase_name: str, year: str, month: str
) -> str:
    dc = _get_root_node_content(
        org_id, codebase_name, ContentKind.DEEP_CONTEXT_CHANGELOG
    )
