...
class TestTypeScriptDriver:
    ...
    def test_extract_imports_count(self, imports_code: str) -> None:
        tree = JsTsDriverTree.from_code(imports_code, Path("test_imports.ts"))
    ...
    def test_extract_functions_count(self, functions_code: str) -> None:
        tree = JsTsDriverTree.from_code(functions_code, Path("test_functions.ts"))
    ...
    def test_extract_classes_count(self, classes_code: str) -> None:
        tree = JsTsDriverTree.from_code(classes_code, Path("test_classes.ts"))
    ...
    def test_extract_interfaces_count(self, interfaces_code: str) -> None:
        tree = JsTsDriverTree.from_code(interfaces_code, Path("test_interfaces.ts"))
    ...
    def test_extract_object_type_count(self, object_types_code: str) -> None:
        tree = JsTsDriverTree.from_code(object_types_code, Path("test_object_types.ts"))
    ...
    def test_extract_variables_count(self, variables_code: str) -> None:
        tree = JsTsDriverTree.from_code(variables_code, Path("test_variables.ts"))
    ...
    def test_extract_enums_count(self, enums_code: str) -> None:
        tree = JsTsDriverTree.from_code(enums_code, Path("test_enums.ts"))
    ...
    def test_extract_methods_count(self, methods_code: str) -> None:
        tree = JsTsDriverTree.from_code(methods_code, Path("test_methods.ts"))
    ...
    def test_extract_calls_count(self, calls_code: str) -> None:
        tree = JsTsDriverTree.from_code(calls_code, Path("test_calls.ts"))
