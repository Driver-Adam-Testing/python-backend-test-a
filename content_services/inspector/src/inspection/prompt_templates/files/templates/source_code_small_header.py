...
SOURCE_CODE_SMALL_TEMPLATE_HEADER = [
    (S.SINGLE_PROMPT_TEXT, "# Purpose", SOURCE_CODE_SMALL_SYSTEM_PROMPT_GENERAL_C_OR_CPP_HEADER, SOURCE_CODE_SMALL_PURPOSE_USER_PROMPT),
    (S.LLM_COND_JSON,      "\n---\n## Imports and Dependencies", default_imports_checker, lambda _llm, output, _code: output, None,),
    (S.FN_COND_JSON,       "\n---\n## Global Variables", header_variables_checker, variables_dict_from_llm_header, None),
    (S.FN_COND_JSON,       "\n---\n## Data Structures", header_data_structure_checker, data_structure_dict_from_llm_header, None,),
    (S.FN_COND_JSON,       "\n---\n## Functions", header_function_checker, fn_dict_from_llm_header, None,),
]
