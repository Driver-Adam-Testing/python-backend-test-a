...
SOURCE_CODE_SMALL_TEMPLATE_PY = [
    ...
    (S.FN_COND_JSON,       "\n---\n## Global Variables", py_variables_checker, variables_dict_from_llm, None),
    (S.FN_COND_JSON,       "\n---\n## Data Structures", py_data_structure_checker, data_structure_dict_from_llm, None,),
    (S.FN_COND_JSON,       "\n---\n## Functions", py_function_checker, fn_dict_from_llm, None,),
]
