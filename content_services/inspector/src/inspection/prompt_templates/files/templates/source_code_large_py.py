...
SOURCE_CODE_LARGE_TEMPLATE_PY = [
    ...
    (S.FN_COND_JSON,       "\n---\n## Global Variables", py_variables_checker, variables_dict_from_llm_py, VARIABLES_NONE_CONTENT),
    (S.FN_COND_JSON,       "\n---\n## Data Structures", py_data_structure_checker, data_structure_dict_from_llm_py, DATA_STRUCTURES_NONE_CONTENT,),
    (S.FN_COND_JSON,       "\n---\n## Functions", py_function_checker, fn_dict_from_llm_py, FUNCTIONS_NONE_CONTENT,),
]
