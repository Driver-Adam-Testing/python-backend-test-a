...
class TestAnalyticsActivityAuthorization:
    ...
    def mock_analytics_service(self):
        ...
        with patch("app.api.routes.v1.analytics.AnalyticsService") as mock:
            mock_instance = MagicMock()
            mock_instance.get_activity.return_value = {
                "codebase_id": "test-id",
                "daily_activity": [
                    {
                        "date": "2024-01-15",
...
class TestAnalyticsOwnershipAuthorization:
    ...
    def mock_analytics_service(self):
        ...
        with patch("app.api.routes.v1.analytics.AnalyticsService") as mock:
            mock_instance = MagicMock()
            mock_instance.get_ownership.return_value = {
                "codebase_id": "test-id",
                "directories": [
                    {
                        "directory_path": "src",
...
class TestResponseSchemaValidation:
    ...
    def test_org_summary_response_matches_schema(
        ...
        from app.schemas.analytics_schema import OrgAnalyticsSummary
    ...
    def test_codebases_list_response_matches_schema(
        ...
        from app.schemas.analytics_schema import CodebasesListResponse
    ...
    def test_overview_response_has_all_required_fields(
        ...
        from app.schemas.analytics_schema import AnalyticsOverview
    ...
    def test_branches_response_matches_schema(
        ...
        from app.schemas.analytics_schema import BranchesResponse
    ...
    def test_activity_response_matches_schema(
        ...
        from app.schemas.analytics_schema import ActivityResponse
    ...
    def test_ownership_response_matches_schema(
        ...
        from app.schemas.analytics_schema import OwnershipResponse
