...
class BitbucketBulkCreator:
    ...
    def delete_all_repositories(
        ...
        for repo in repositories:
            ...
            if include_patterns:
                if not any(pattern in repo_name for pattern in include_patterns):
                    continue
    ...
    def create_readme_content(self, repo_name: str, description: str = None) -> str:
...
"""
    ...
    def create_repository(
        self, repo_name: str, is_private: bool = True, description: str = None
    ) -> dict[str, Any]:
        """
    ...
    def create_repositories_parallel(
        ...
        def create_single_repo(repo_name):
