...
class SurveyCreate(BaseModel):
    skipped: bool = False
    plans_for_driver: list[str] | str | None = None
        ...
        record = AboutYouSurvey(
            ...
            plans_for_driver=(
                ...
                if payload.skipped
                    ...
                    payload.plans_for_driver
                    if isinstance(payload.plans_for_driver, list)
                    else ([payload.plans_for_driver] if payload.plans_for_driver else None)
                )
            ),
