...
Ultimately generate an exhaustive table as its desired output."""


def execute_table_block_agent(input: PipelineInput) -> PipelineResponse:
    ...
    default_agent_input = PipelineStepConfiguration(
        ...
        response_format=BlockKindCopyEditorTable,
    )
