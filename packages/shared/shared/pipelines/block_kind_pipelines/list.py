...
Ultimately generate an exhaustive single list as its desired output."""


def execute_list_block_agent(input: PipelineInput) -> PipelineResponse:
    ...
    default_agent_input = PipelineStepConfiguration(
        ...
        response_format=BlockKindCopyEditorList,
    )
