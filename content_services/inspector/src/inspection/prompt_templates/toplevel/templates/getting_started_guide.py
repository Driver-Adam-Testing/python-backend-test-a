...
GETTING_STARTED_GUIDE_TEMPLATE = [
    ...
    (S.SINGLE_PROMPT_TEXT, "## Purpose", PURPOSE_PROMPT),
    (S.SINGLE_PROMPT_TEXT, "## Problem Statement", PROBLEM_STATEMENT_PROMPT),
    (S.SINGLE_PROMPT_TEXT, "## Functionality Overview", FUNCTIONALITY_OVERVIEW_PROMPT),
    (S.RAW,                "# User Information",),
    (S.SINGLE_PROMPT_TEXT, "## Target User Archetype(s)", TARGET_USER_ARCHETYPES_PROMPT),
    (S.SINGLE_PROMPT_TEXT, "## Use Cases and User Interactions", USE_CASES_AND_USER_INTERACTIONS_PROMPT),
    (S.SINGLE_PROMPT_TEXT, "## User Journeys", USER_JOURNEYS_PROMPT),
    (S.SINGLE_PROMPT_TEXT, "## Interaction Methods", USER_INTERACTION_METHODS_PROMPT),
    (S.RAW,                "# Technical Overview",),
    (S.SINGLE_PROMPT_TEXT, "## Codebase Organization and Structure", CODEBASE_ORGANIZATION_AND_STRUCTURE_PROMPT),
    # (S.SINGLE_PROMPT_TEXT, "## Unique Aspects or Design Patterns", "Highlight any unique aspects or design patterns used in this codebase. Infer an answer to this by evaluating what you know about this codebase."),
    # (S.SINGLE_PROMPT_TEXT, "## Codebase Type", "Specify the type of codebase, e.g., executable, library, SDK, API, frontend apps, backend service, data pipeline. Infer an answer to this by evaluating what you know about this codebase."),
    (S.SINGLE_PROMPT_TEXT, "## Major Modules/Services", MAJOR_MODULES_PROMPT),
    (S.SINGLE_PROMPT_TEXT, "## Component Interactions", COMPONENT_INTERACTIONS_PROMPT),
    (S.RAW,                "# Getting Started",),
    (S.SINGLE_PROMPT_TEXT, "## Setup and Installation", SETUP_AND_INSTALLATION_PROMPT),
    # (S.SINGLE_PROMPT, "## Basic Usage Examples", "Offer simple examples demonstrating basic usage of the codebase"),
    (S.SINGLE_PROMPT_TEXT, "## Continued Exploration", CONTINUED_EXPLORATION_PROMPT),
]
