...
SOURCE_CODE_LARGE_MULTI_PROMPT_TEMPLATE_C = [
    # (S.RAW,                 "# Overview"),
    (S.MULTI_PROMPT_TEXT,   "# Purpose", SOURCE_CODE_LARGE_SYSTEM_PROMPT_GENERAL_C, SOURCE_CODE_LARGE_PURPOSE_USER_PROMPT_MULTI_CONTEXT, SOURCE_CODE_PURPOSE_FROM_CHUNKS,),
